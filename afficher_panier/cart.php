...
<main>
    ...
    <span id="total"></span>
    <p><a id='btn-checkout-cart' class=' btn btn-success btn-block' onclick='checkoutCart();' >Valider</a></p>
    <p><a id='btn-delete-cart' class=' btn btn-primary btn-block' onclick='deleteCart();' >Vider panier</a></p>
</main>
