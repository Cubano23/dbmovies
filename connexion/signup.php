    ...
    <section class="container-fluid">        
        <fieldset>
                <legend>S'inscrire</legend>
                    ...
                    <div class="form-group">
                        <input id="code" name="code" placeholder="Code postal" class="form-control margin">
                    </div>
                    <div class="form-group">
                        <input id="ville" name="ville" placeholder="Ville" class="form-control margin">
                    </div>
                    <ul class="list-group">
                        <li data-vicopo="#ville, #code" data-vicopo-click='{"#code": "code", "#ville": "ville"}' class="list-group-item li-ville">
